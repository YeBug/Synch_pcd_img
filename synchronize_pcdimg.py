...
seg_img_path = "D:\\data\\testdata\subdata\\"
...
if __name__ == "__main__":
    img_list = os.listdir(seg_img_path)
    img_list.sort()
    pcd_list = os.listdir(pcd_path)
    interp_list = os.listdir(seg_img_path)
    interp_index = 0
    ...
    for index in range(len(pcd_list)):
        ...
        for i in range(9):
            ...
            cur_error = proj2img(cam, label, cache_seg)
